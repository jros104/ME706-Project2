...
// Fire Detection
#define FIRE_DETECTION_ROTATION_SPEED 0.15  
...
#define OBSTIK_CLEAR_SONAR 11
#define OBSTIK_CLEAR_IR 13

#define OBSTIK_FRONT_MIN_IR 5.5
#define OBSTIK_FRONT_MIN_SONAR 3.5

#define OBSTIK_DISTANCE_CHECK_SPEED 3
#define OBSTIK_DISTANCE_CHECK_TIME 100
#define OBSTIK_ROTATE_CHECK_SPEED 0.22
#define OBSTIK_ROTATE_CHECK_TIME 220

#define AVOID_SPEED BASE_SPEED
#define AVOID_DELAY_SIDEWAYS 0
